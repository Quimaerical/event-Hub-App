...
class AppTheme {
  ...
  static const Color brandViolet = Color(
    0xFF8B5CF6,
  ); // Brand 500 (#8b5cf6) - Primary Accent
  static const Color brandDeep = Color(
    0xFF7C3AED,
  ); // Brand 600 (#7c3aed) - Primary Buttons & Highlights
  static const Color brandDark = Color(
    0xFF4C1D95,
  ); // Brand 900 (#4c1d95) - Category Badge Backgrounds
  static const Color brandLight = Color(
    0xFFEDE9FE,
  ); // Brand 100 (#ede9fe) - Category Text
  static const Color accentEmerald = Color(
    0xFF10B981,
  ); // Emerald 500 (#10b981) - Approved / Success
  ...
  static const Color cardBgLight = Color(
    0xFFFFFFFF,
  ); // White (#ffffff) - Light card background
