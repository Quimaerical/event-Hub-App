  ...
  group('AppValidators Tests', () {
    group('validateEmail', () {
      ...
      test('should return error message when email format is invalid', () {
        ...
        expect(
          AppValidators.validateEmail('abc@'),
          'Ingrese un correo electrónico válido',
        );
        expect(
          AppValidators.validateEmail('abc@domain'),
          'Ingrese un correo electrónico válido',
        );
      });
    ...
    group('validateRequired', () {
      test(
        'should return error message with field name when value is null or empty',
        () {
          expect(
            AppValidators.validateRequired(null, 'Nombre'),
            'Nombre es obligatorio',
          );
          expect(
            AppValidators.validateRequired('', 'Nombre'),
            'Nombre es obligatorio',
          );
          expect(
            AppValidators.validateRequired('   ', 'Nombre'),
